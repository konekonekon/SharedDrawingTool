...
public class Circle extends Shape {
	...
	/*
	 * public void drawTestCircles(Graphics2D g2d){ int leftForSmall = center.x
	 * - (int)(radius * 0.9); int topForSmall = center.y - (int)(radius * 0.9);
	 * int leftForBig = center.x - (int)(radius * 1.1); int topForBig = center.y
	 * - (int)(radius * 1.1);
	 * 
	 * g2d.setColor(Color.BLUE); g2d.setStroke(new BasicStroke(1));
	 * g2d.fillOval(center.x-2, center.y-2, 4, 4); g2d.drawOval(leftForSmall,
	 * topForSmall, (int)(radius * 0.9 *2), (int)(radius * 0.9 *2));
	 * g2d.drawOval(leftForBig, topForBig, (int)(radius * 1.1 *2), (int)(radius
	 * * 1.1 *2)); }
	 */
	...
	public String encode() {
		return "Circle " + Integer.toString(center.x) + " "
				+ Integer.toString(center.y) + " " + Integer.toString(radius);
	}

	public static Shape decode(String data) {
		String[] elements = data.split(" ");
		Circle aCircle = null;
		Point p = new Point(Integer.parseInt(elements[1]),
